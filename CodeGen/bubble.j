...
L0:
.var 0 is this LCodeGen/bubble; from L0 to L1
...
.var 1 is vc$ LCodeGen/bubble; from L0 to L1
	new CodeGen/bubble
	dup
	invokenonvirtual CodeGen/bubble/<init>()V
	astore_1
...
"
	...
	aload 2
	iload_3
	invokevirtual CodeGen/bubble/printIntArray([II)V
	aload_1
	aload 2
	iload_3
	invokevirtual CodeGen/bubble/bubbleSort([II)V
